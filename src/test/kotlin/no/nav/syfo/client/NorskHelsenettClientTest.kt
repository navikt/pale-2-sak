...
class NorskHelsenettClientTest {
    ...
    private val norskHelsenettClient =
        NorskHelsenettClient("$mockHttpServerUrl/syfohelsenettproxy", accessTokenClient, "resourceId", httpClient)
    ...
    internal fun `NorskHelsenettClient Returnerer null hvis respons er 404`() {
        val behandler = runBlocking { norskHelsenettClient.getByFnr("behandlerFinnesIkke", loggingMeta) }
